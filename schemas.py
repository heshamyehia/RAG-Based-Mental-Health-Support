...
class ChatResponse(BaseModel):
    ...
    session_id: str = Field(
        ..., description="Chat session ID for continuity and feedback tracking."
    )
    ...
    raw_intent: Optional[Intent] = Field(
        None, description="Original classifier output before any fallback override."
    )
